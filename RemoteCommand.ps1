...
# RemoteCommand.ps1 -Hostname USTR-R3T27S22.ap.uis.unisys.com -Username USTR-R3T27S22\ABSuite -Password Unisys*2012 -FilePath "D:\huangchuang\scripts-exercise\GetMachineInfo.ps1"
